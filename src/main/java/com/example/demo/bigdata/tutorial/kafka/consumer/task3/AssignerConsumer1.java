 ...
 * @Version: 1.0
 */
public class AssignerConsumer1 {
...
//        properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        ...
        // 设置分区分配策略
//        properties.put(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG,KafkaUtils.ROUND_ROBIN);
        properties.put(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, KafkaUtils.STICKY);

        // 提交方式
        properties.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, true); // 自动
